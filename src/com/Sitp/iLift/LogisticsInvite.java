...
public class LogisticsInvite {

	public static JSONObject start(String logistics_id, String sender_id, String sender_type, String travel_id) {
		String url = "http://221.239.199.19:8080/ilifting/logisticsInvite.do";
