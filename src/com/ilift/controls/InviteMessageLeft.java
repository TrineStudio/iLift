...
public class InviteMessageLeft extends RelativeLayout
{
	...
	public InviteMessageLeft(Context context) 
	{
		super(context);
		
		
		LayoutInflater.from(context).inflate(R.layout.status_message, this, true);
